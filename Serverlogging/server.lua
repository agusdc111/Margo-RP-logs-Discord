...
AddEventHandler('playerConnecting', function() 
    ...
    sendToDiscord("Inicio de sesion", "**" .. GetPlayerName(source) .. "** se esta conectando al servidor.", 65280)
end)
...
AddEventHandler('playerDropped', function(reason) 
  ...
  sendToDiscord("Cierre de sesion", "**" .. GetPlayerName(source) .. "** se fue a dormir. \n Razon: " .. reason, color)
end)

RegisterServerEvent('playerDied')
AddEventHandler('playerDied',function(message)
    sendToDiscord("Muerte", message, 16711680)
end)
