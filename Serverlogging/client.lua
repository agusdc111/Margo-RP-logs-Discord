    ...
    while true do
        ...
        if IsEntityDead(playerPed) and not alreadyDead then
            ...
            elseif checkArray (Animal, death) then
                TriggerServerEvent('playerDied', playerName .. " murio por un animal")
            elseif checkArray (FallDamage, death) then
                TriggerServerEvent('playerDied', playerName .. " murio por una caida")
            ...
            elseif checkArray (Gas, death) then
                TriggerServerEvent('playerDied', playerName .. " murio por gas)
            elseif checkArray (Burn, death) then
                TriggerServerEvent('playerDied', playerName .. " fue quemado vivo")
            elseif checkArray (Drown, death) then
                TriggerServerEvent('playerDied', playerName .. " murio ahogado")
            else
                TriggerServerEvent('playerDied', playerName .. " fue asesinado por una fuerza desconocida")
                --print(death)
            end
